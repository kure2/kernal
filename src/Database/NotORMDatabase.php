...
class NotORMDatabase /** implements Database */ {
    ...
    */
    ...
    protected $newInstance = true;

    /**
     * @param bool $newInstance
     */
    public function setNewInstance(bool $newInstance)
    {
    ...
    public function __get($name) {
        ...
        if (!isset($this->_notorms[$notormKey]) || ($this->newInstance == true)) {
    ...
    public function commit($whichDB) {
       return $this->getPdo($whichDB)->commit();
    }
    ...
    public function rollback($whichDB) {
       return $this->getPdo($whichDB)->rollback();
    }
}
